        ...
        <div class="hero">
            <div class="row justify-content-md-center">
                ...
                <div class="col col-lg-5" style="margin-top: 10%;">
                    ...
                    <h2 class="text-center hero-lead">Say "I Do" to Stress-Free Planning! and a perfect wedding</h2>
                ...
                <div class="pricing">
                    <ul class="list-group list-unstyled">
                        ...
                        <?php $feature = Features::find_by_feature_all($category_row->id); ?>
                            ...
                            <?php endforeach; ?>
                        <li class="list-group-item font-weight-bold">Price: Million <?= number_format($category_row->price); ?>
                         </li>
    ...
    <div class="row">
        <div class="col-12 col-md">
            <div class="text-center">
                <small class="d-block mb-3 text-muted">&copy; <?php echo date('Y')?> - Developed By Rodrwick Awasum</small>
            </div>
        </div>
    </div>
</footer>
